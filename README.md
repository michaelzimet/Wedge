...
The scripts plot_Electrode_cyl.m and plot_Electrode_dir.m generate Figures 1 and 2 respectively. These are based on the scripts calc_runCyl.m and calc_runDir.m along with the functions cylPot.m and dirPot.m respectively. The script plot_at_mesh_nodes.m along with calc_at_mesh_nodes.m generates Figures S1 and S2. 
