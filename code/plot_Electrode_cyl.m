...
%% Create interpolants
F = scatteredInterpolant(x', y', z', potC4', 'natural', 'none');
F2 = scatteredInterpolant(x', y', z', cyl', 'natural', 'none');
...
set(gcf,'Color','w')
saveas(gcf, 'electrode_fig.eps', 'epsc');
%}
...
ticks = [60 70 80 90 100 200 300 400 500 600];
...
%tlo.Padding = 'compact';
set(gcf,'Color','w')
saveas(gcf, 'figs/electrode_cyl.eps', 'epsc');
